...
import { Briefcase, Bell, User as UserIcon, LogOut, LayoutDashboard, FileText, Settings, Search } from 'lucide-react';
...
export default function ProfessionalDashboardLayout({
  ...
  const navLinks = [
    ...
    { name: 'Clientes', href: '/dashboard/profissional/clientes', icon: UserIcon },
    { name: 'Perfil', href: '/dashboard/profissional/perfil', icon: Settings },
  ];

  return (
    <div className="min-h-screen bg-bp-surface-low">
      {/* Top Navigation */}
        ...
        <div className="container mx-auto px-4 h-16 flex items-center justify-between overflow-visible">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="relative p-2 rounded-xl hover:bg-white/5 transition-colors">
              ...
              <span className="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full border-2 border-[#103569]"></span>
            </button>
            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                <div className="text-right hidden sm:block">
                  <p className="text-xs font-black text-white">Construtora Silva</p>
                  <p className="text-[10px] font-bold text-[#f7941d] uppercase tracking-widest">Plano Diamante</p>
                </div>
              ...
              {menuOpen && (
                <div className="absolute right-0 top-full mt-1 w-64 bg-white rounded-2xl shadow-2xl border border-[#103569]/10 py-2 z-100 animate-in fade-in zoom-in duration-200">
                  <div className="px-4 py-3 border-b border-[#103569]/5 mb-1 bg-slate-50/50 rounded-t-2xl">
                    ...
                    <p className="text-sm font-bold text-[#103569]">Construtora Silva</p>
                  </div>
                  ...
                  <button 
                    ...
                    className="flex items-center gap-3 px-4 py-2.5 w-full text-left text-sm font-bold text-red-600 hover:bg-red-50 transition-colors border-none cursor-pointer"
                  >
                    <LogOut size={16} />
                    Sair da Conta
                  </button>
